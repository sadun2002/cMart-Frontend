...
import { Download, Monitor, Smartphone, Apple, CheckCircle2 } from 'lucide-react';
  ...
  const osOptions = [
    {
      ...
      fileName: 'cMart-Windows-Setup-v2.1.0.exe'
    },
    {
      id: 'mac',
      name: 'macOS',
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {osOptions.map((os) => (
              <div 
                key={os.id} 
                className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-gray-100 dark:border-slate-800 shadow-xl shadow-gray-200/50 dark:shadow-none flex flex-col hover:-translate-y-1 transition-transform duration-300"
              >
                ...
                <div className="flex items-center gap-3 mb-3">
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{os.name}</h2>
                ...
                <p className="text-gray-500 dark:text-slate-400 text-sm mb-6 flex-1">
                  {os.description}
                </p>
                ...
                <button 
                  className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl text-sm transition-all flex items-center justify-center gap-2"
                >
