...
export default function OwnerTopbar({ collapsed, onToggle, onMobileMenuToggle }: { collapsed?: boolean; onToggle?: () => void; onMobileMenuToggle?: () => void } = {}) {
          ...
          <div className="relative ml-1" ref={profileRef}>
            ...
            <div className={`absolute right-0 mt-2 w-52 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-gray-100 dark:border-slate-700 transition-all duration-200 z-50 ${profileOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-2'}`}>
              ...
              <div className="p-1">
                ...
                <Link href="/owner/settings/personal" onClick={() => setProfileOpen(false)} className="block px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors">Personal Profile</Link>
                <Link href="/owner/settings/profile" onClick={() => setProfileOpen(false)} className="block px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors">Store Profile</Link>
                <Link href="/owner/settings/security" onClick={() => setProfileOpen(false)} className="block px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700/50 rounded-lg transition-colors">Security Settings</Link>
              </div>
