          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4">
              {customizations.socialLinks?.facebook?.enabled && (
                <a href={customizations.socialLinks.facebook.url || "#"} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                  <span className="sr-only">Facebook</span>
                  <Facebook className="h-5 w-5" />
                </a>
              )}
              {customizations.socialLinks?.instagram?.enabled && (
                <a href={customizations.socialLinks.instagram.url || "#"} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                  <span className="sr-only">Instagram</span>
                  <Instagram className="h-5 w-5" />
                </a>
              )}
              {customizations.socialLinks?.twitter?.enabled && (
                <a href={customizations.socialLinks.twitter.url || "#"} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                  <span className="sr-only">Twitter</span>
                  <Twitter className="h-5 w-5" />
                </a>
              )}
              {customizations.socialLinks?.youtube?.enabled && (
                <a href={customizations.socialLinks.youtube.url || "#"} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                  <span className="sr-only">YouTube</span>
                  <Youtube className="h-5 w-5" />
                </a>
              )}
              {customizations.socialLinks?.linkedin?.enabled && (
                <a href={customizations.socialLinks.linkedin.url || "#"} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
                  <span className="sr-only">LinkedIn</span>
                  <Linkedin className="h-5 w-5" />
                </a>
              )}
              {customizations.socialLinks?.whatsapp?.enabled && (
                <a href={customizations.socialLinks.whatsapp.url || "#"} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
              ...
              {customizations.socialLinks?.tiktok?.enabled && (
                <a href={customizations.socialLinks.tiktok.url || "#"} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">
